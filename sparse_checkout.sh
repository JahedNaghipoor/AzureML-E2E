...
git_folder_location='/Users/jaheed.naghipoor/Projects'  #replace with the local root folder location where you want to create the project folder
project_name=AzureML-MLOps   #replace with your project name
github_org_name=JahedNaghipoor   #replace with your github org name
project_template_github_url=https://github.com/JahedNaghipoor/AzureML-E2E
